...
class GigasecondTest < Minitest::Test
  def test_2011_04_25
    gs = Gigasecond.from(Time.utc(2011, 4, 25, 0, 0, 0)) # year, month, day, hours, minutes, seconds
  ...
  def test_with_your_birthday
    gs = Gigasecond.from(Time.utc(1994, 10, 27, 7, 0, 0))
    assert_equal Time.utc(2026, 7, 5, 8, 46, 40), gs
  end
